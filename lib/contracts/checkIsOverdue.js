 ...
 */
export async function checkIsOverdue(tokenAddress, account, signer, chainId) {
  ...
  try {
    ...
    /**
     * @description Calls the `checkIsOverdue` function on the retreived contract
     */
    const res = await contract.checkIsOverdue(account);
