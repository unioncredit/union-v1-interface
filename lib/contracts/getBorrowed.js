 ...
 */
export async function getBorrowed(account, tokenAddress, signer, chainId) {
  ...
  try {
    ...
    /**
     * @description Calls the `getBorrowed` function on the retreived contract
     */
    console.log("........");
    const res = await contract.getBorrowed(account);
    console.log(res);
