 ...
 */
export async function getLastRepay(tokenAddress, account, signer, chainId) {
  ...
  try {
    ...
    /**
     * @description Calls the `getLastRepay` function on the retreived contract
     */
    const res = await contract.getLastRepay(account);
