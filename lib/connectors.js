import { Avatar, Metamask, WalletConnect } from "union-ui";
...
export const networkImages = {
  ...
  4: "/images/ethereum.png",
  42: "/images/ethereum.png",
...
export const SUPPORTED_WALLETS = {
  ...
  MetaMask: {
    ...
    name: "MetaMask",
    color: "#E8831D",
    icon: <Avatar size={48} src={Metamask} />,
  },
  WalletConnect: {
    connector: walletconnect,
    name: "WalletConnect",
    color: "#4196FC",
    icon: <Avatar size={48} src={WalletConnect} />,
  },
};
